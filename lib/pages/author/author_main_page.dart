...
class AuthorMainPageState extends State<AuthorMainPage> with AutomaticKeepAliveClientMixin {
  List<Item> itemList = [];
                ...
                SliverList(
                  delegate: SliverChildBuilderDelegate(
                    (context, index) {
                      ...
                      } else if (this.itemList[index].type == 'textHeader') {
                        return Padding(
                      ...
                      } else if (this.itemList[index].type == 'textFooter') {
                        return Container(
