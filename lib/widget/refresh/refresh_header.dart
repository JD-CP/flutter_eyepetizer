...
/// 经典Header
class MyClassicalHeader extends Header {
  /// Key
  final Key key;
  ...
  Widget contentBuilder(
      ...
      bool success,
      bool noMore) {
    return MyClassicalHeaderWidget(
      key: key,
...
/// 经典Header组件
class MyClassicalHeaderWidget extends StatefulWidget {
  final MyClassicalHeader classicalHeader;
  ...
  @override
  MyClassicalHeaderWidgetState createState() => MyClassicalHeaderWidgetState();
}

class MyClassicalHeaderWidgetState extends State<MyClassicalHeaderWidget>
    with TickerProviderStateMixin<MyClassicalHeaderWidget> {
  // 是否到达触发刷新距离
